...
const Cart_Wish = ({ img, name, qty, wish, cart, price, discount, hide }) => {
  return (
    <div
      className={`md:w-[320px] md:h-[160px] h-[220px] w-[280px] bg-white shadow-xs shadow-gray-500 rounded fixed bottom-20 right-10 flex flex-wrap transition-all duration-300 z-[199] ${
