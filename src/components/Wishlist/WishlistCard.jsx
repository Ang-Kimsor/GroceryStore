...
const WishlistCard = ({
  ...
  return (
    <tr className="border-y-1 w-full h-[40px] relative border-gray-500/30">
      ...
      <th className=" w-1/5 absolute top-1/2 -translate-y-1/2 justify-evenly flex lg:flex-nowrap flex-wrap lg:gap-0 gap-1 m-0 py-5 text-[12px] font-medium text-[#3C4242]">
        <button
          onClick={() => removefromWishlist(id)}
          className="size-[30px] lg:w-fit lg:px-5 py-1 rounded text-white font-medium cursor-pointer bg-red-500"
        >
        ...
        <button
          ...
          className={` size-[30px] lg:w-fit lg:px-5 py-1 rounded text-white text-[10px] font-medium cursor-pointer bg-[#59C491]`}
        >
